...
sigma_logM, logM0, logM1 = fixed_params
...
def _get_lnprior(theta):
    logMmin, alpha = theta#, alpha, logM0, logM1 = theta
    if 10.< logMmin <13. and 0.25 < alpha < 3.5: #and 1.0<alpha<1.3 and 11.<logM0<11.5 and 13.<logM1<13.5:
        return 0.0
    return -np.inf
...
backend = emcee.backends.HDFBackend('two_param_fit.h5')
